...
public class Rune extends AbstractDynamicCard {
    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID(Rune.class.getSimpleName());
    public static final String IMG = makeCardPath("Rune.png");
