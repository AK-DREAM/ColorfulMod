...
public class Continuous extends AbstractDynamicCard {
    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID(Continuous.class.getSimpleName());
    public static final String IMG = makeCardPath("Continuous.png");
