...
public class UpgradePaint extends AbstractDynamicCard {
    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID(UpgradePaint.class.getSimpleName());
    public static final String IMG = makeCardPath("UpgradePaint.png");
