...
public class Torch extends AbstractDynamicCard {
    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID(Torch.class.getSimpleName());
    public static final String IMG = makeCardPath("Torch.png");
