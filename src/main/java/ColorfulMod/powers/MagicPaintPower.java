...
public class MagicPaintPower extends AbstractColorPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = DefaultMod.makeID("MagicPaintPower");
    ...
    public MagicPaintPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public int calc() {
        ...
        return Math.max(0, (tmp == null ? 0 : tmp.amount) + 3);
    }
    ...
    public void updateDescription() {
        description = DESCRIPTIONS[0] + 3 + DESCRIPTIONS[1] + amount + DESCRIPTIONS[2];
    }

    @Override
    public AbstractPower makeCopy() {
        return new MagicPaintPower(owner, source, amount);
    }
}
