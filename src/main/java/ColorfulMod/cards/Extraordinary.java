...
public class Extraordinary extends AbstractDynamicCard {
    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID(Extraordinary.class.getSimpleName());
    public static final String IMG = makeCardPath("Extraordinary.png");
    ...
    public void onUseCard() {
        if (this.myColor == MyCardColor.NO_COLOR) this.updateCost(1);
        super.onUseCard();
    }
