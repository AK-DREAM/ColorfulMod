...
@AutoAdd.Ignore
public class ColorfulForm extends AbstractDynamicCard {
    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID(ColorfulForm.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new ColorfulFormPower(p, p)));
    }
